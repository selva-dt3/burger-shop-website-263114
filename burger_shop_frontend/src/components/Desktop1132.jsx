      ...
      >
        ...
        <section id="grp-13-26" aria-label={ariaLabels?.heroGroup || 'Hero Title Group'} data-id="13:26">
          <div id="grp-13-26-inner">
            <h2
              id="txt-13-25"
              data-id="13:25"
              className="u-anim-base u-reveal u-stagger-1"
              data-anim="enter"
            >
              {heroTitle}
            </h2>
            <h1
              id="txt-13-24"
              data-id="13:24"
              className="u-anim-base u-reveal u-stagger-2"
              data-anim="enter"
            >
              {heroHeading}
            </h1>
            <p
              id="txt-15-43"
              data-id="15:43"
              className="u-anim-base u-reveal u-stagger-3"
              data-anim="enter"
            >
              {heroSubtitle}
            </p>
        ...
        <nav id="navbar-13-4" aria-label={ariaLabels?.navbar || 'Primary'} data-id="13:4">
          <div id="navbar-13-4-inner">
            ...
            {/* Frame 1 (Home) */}
            <div id="nav-fr-13-5" className="nav-item u-anim-base u-hover-cta" data-id="13:5" data-label={home} role="link" tabIndex={0}>
              <span className="txt">{home}</span>
            </div>

            {/* Frame 2 (Menu) */}
            <div id="nav-fr-13-7" className="nav-item u-anim-base u-hover-cta" data-id="13:7" data-label={menu} role="link" tabIndex={0}>
              <span className="txt">{menu}</span>
            </div>

            {/* Frame 3 (About) */}
            <div id="nav-fr-13-11" className="nav-item u-anim-base u-hover-cta" data-id="13:11" data-label={about} role="link" tabIndex={0}>
              <span className="txt">{about}</span>
            </div>

            {/* Frame 4 (Shop) */}
            <div id="nav-fr-13-13" className="nav-item u-anim-base u-hover-cta" data-id="13:13" data-label={shop} role="link" tabIndex={0}>
